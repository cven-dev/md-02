...
-   The CSV file 'country_level_data_0.csv' is imported from the 'md-02/data' directory using the `read_csv()` function
...
6.  Go to your md-02-USERNAME GitHub repo (where USERNAME is your GitHub username) and refresh the page. You should see your commit message next to the updated files.

## Open an issue on GitHub

Once you have ensured that the Quarto document renders without errors and you have pushed all your changes to GitHub, it is time to complete the assignment by opening an issue on your md-02-USERNAME GitHub repo (where USERNAME is your GitHub username).

1.  Navigate to your md-02-USERNAME GitHub repo (where USERNAME is your GitHub username).
